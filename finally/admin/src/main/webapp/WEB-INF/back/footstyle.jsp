...
<script src="${pageContext.request.contextPath}/static/assets/plugins/jquery-validation/js/localization/messages_zh.js"></script>
<!-- iCheck 1.0.1 -->
...
<%--App--%>
<script src="${pageContext.request.contextPath}/static/assets/app/validation.js"></script>
